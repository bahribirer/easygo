    ...
    transitionBuilder: (ctx, anim, _, __) {
      return Transform.scale(
        ...
        child: Opacity(
          ...
          child: Stack(
            children: [
              BackdropFilter(filter: ImageFilter.blur(sigmaX: 6, sigmaY: 6), child: Container()),
              Center(
                child: Material(
                  color: Colors.white,
                              ...
                              if (secondaryText != null)
                                Expanded(
                                  child: TextButton(
                                    ...
                                    child: Text(secondaryText!, style: const TextStyle(fontWeight: FontWeight.w600)),
                                  ),
                                ),
...
Future<bool> showConfirm(BuildContext c,
        {required String title, String? message, String ok = 'Onayla', String cancel = 'Vazgeç'}) =>
    showAppPopup(c,
        type: AppPopupType.info, title: title, message: message, primaryText: ok, secondaryText: cancel);
